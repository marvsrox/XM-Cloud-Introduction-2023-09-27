...
export function FEAASEditorProps(element = this) {
    var _a;
    return {
        context: HTMLElement,
...
export class FEAASEditor extends FEAASBase {
    constructor() {
        super(...arguments);
    ...
    render({ children, component: componentId, version: versionId, instance: instanceId }, { Editor, VersionStatusList, VersionStatusButton, Version, VersionMenu, EditorUIUndo, EditorUIMode, React: { useEffect, useMemo, useState, useContext }, Chakra: { HStack, Box, Button, MenuItem }, Chrome, ReactDOM, useSDK, useSlots, useModelObserver, ConfirmationContext, VersionContext }) {
        if (!this.payload)
            return;
        ...
        return useMemo(() => component &&
            useSlots(children, ({ picker, children }) => (React.createElement(Box, { ref: (el) => {
                ...
                React.createElement(Box, { className: 'editor-wrapper', position: 'absolute', left: 0, top: 0 },
                    React.createElement(Editor, { datasources: sdk.datasources, sdk: sdk, library: sdk.library, component: component, versions: versions, context: {
