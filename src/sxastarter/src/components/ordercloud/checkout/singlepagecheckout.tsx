...
const OcCheckout: FunctionComponent<{ onSubmitted: any }> = ({}) => {
  ...
  return (
    <>
      <VStack w="100%" width="full" justifyContent="space-between">
          ...
          <VStack w="100%" width="full">
            <HStack w="100%" width="full" alignItems="flex-start">
              ...
              <VStack w="80%" justifyContent="flex-start" textAlign="left">
                <Text w="100%" width="full" textAlign="left" fontSize="12">
              ...
              <Link onClick={() => setIsAddressModalOpen(true)}>
                <Text textDecoration="underline" textColor="brand.500" fontSize="12">
                  Change
                </Text>
              </Link>
            </HStack>
            ...
            <HStack w="100%" width="full" alignItems="flex-start">
              ...
              <VStack w="80%" justifyContent="flex-start" textAlign="left">
                <HStack w="100%" width="full" textAlign="left" fontSize="12">
                  <Box
                    border="1px"
