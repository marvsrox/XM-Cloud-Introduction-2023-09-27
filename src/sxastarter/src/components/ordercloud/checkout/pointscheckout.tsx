  ...
  return (
    <>
      ...
      >
        ...
        <HStack w="100%" width="full" textAlign="left" alignItems="flex-start">
          <VStack w="100%" width="full" textAlign="left" alignItems="flex-start">
            <Heading fontSize="sm" mb="32px">
              Points available:
            </Heading>
            <Box border="1px" borderColor="gray.400" borderRadius="lg" bgColor="white" p={10}>
              <Text fontSize="xl">{formatPoints(availablePoints)} pts</Text>
            </Box>
          </VStack>
          <VStack w="100%" width="full" textAlign="left" alignItems="flex-start">
            <Heading width="180px" fontSize="sm">
          ...
          <VStack w="100%" width="full">
            <HStack w="100%" width="full">
              <VStack w="100%" width="full" textAlign="left" alignItems="flex-start">
                <Heading fontSize="sm" color="gray.200" mb="32px">
                  Credit card:
                </Heading>
                <Box border="1px" borderColor="gray.200" borderRadius="lg" bgColor="white" p={10}>
              ...
              <HStack w="100%" width="full">
                <VStack w="100%" width="full" textAlign="left" fontSize="12">
                  <Box
                    border="1px"
          ...
          <VStack w="100%" width="full">
            ...
            >
              ...
              <VStack justifyContent="flex-start" textAlign="left" w="100%" width="full" pl="10">
                ...
                <Text w="100%" width="full" fontSize="12">
