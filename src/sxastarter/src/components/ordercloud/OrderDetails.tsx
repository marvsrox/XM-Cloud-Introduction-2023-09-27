      ...
      >
        <Container maxW="container.xl" w="100%" width="full">
          ...
          <HStack alignItems="flex-start">
            ...
            {order && (
              <VStack width="full">
                <HStack width="full" justifyContent="space-between" alignItems="top">
                  <VStack alignItems="start" maxW="1280px">
                    <HStack>
                      <Text>Order Number:</Text>
                      <Text fontWeight="bold" color="PrimaryButtonBG">
                        {order?.ID}
                      </Text>
                    </HStack>
                    ...
                    <VStack alignItems="start" marginBottom={10}>
                      <Text fontWeight="bold" color="PrimaryButtonBG">
                        Billing Address
                      </Text>
                      <AddressCard address={billingAddress} fontSize="md" />
                    </VStack>
                  </VStack>
                  <Card variant="elevated" minWidth="400px">
                    <CardHeader>
                      <Text fontWeight="bold" color="PrimaryButtonBG">
                        Order Summary
                      </Text>
                    ...
                    <CardBody pt="0px">
                      <VStack w="100%" width="full">
                        ...
                        <HStack w="100%" width="full">
                          ...
                          <Box w="100%" width="full">
                            <Text float="right">{order?.PromotionDiscount}</Text>
                          </Box>
                        </HStack>
                        <HStack w="100%" width="full">
                          <Box w="100%" width="full">
                          ...
                          <Box w="100%" width="full">
                            <Text float="right">{order?.TaxCost}</Text>
                          </Box>
                        </HStack>
                        {order?.xp?.tip && (
                          <HStack w="100%" width="full">
                ...
                <VStack alignItems="start" marginBottom={10} mt={10}>
                  <Text fontWeight="bold" color="PrimaryButtonBG">
                    Line Items
                  </Text>
                  <TableContainer>
