...
export const Default = (props: LandingPageProps): JSX.Element => {
  ...
  const [promos, setPromos] = useState([] as Promotion[]);
  ...
  useEffect(() => {
    const getPackages = async () => {
      const packages = await Me.ListProducts({
        filters: { 'xp.ProductType': 'AramarkMealPlan' },
        sortBy: ['xp.MealsPerSemester'],
      });
  ...
  useEffect(() => {
    const getPromos = async () => {
      const promos = await Me.ListPromotions({
        filters: { 'xp.ProductType': 'Mealplan' },
      });
      setPromos(promos.Items);
    };
    getPromos();
  }, []);
    ...
    >
      ...
      >
        <Container as="form" onSubmit={onFormSubmit} maxW="container.xl" w="100%" width="full">
          <VStack w="100%" width="full" maxW="1280px" textAlign="left" alignItems="flex-start">
            ...
            <Heading fontSize="lg">Available Promotions:</Heading>
            <Heading fontSize="md" fontWeight="normal">
              These are the active promotions available, the correct promo will be applied upon
              checkout.
            </Heading>
              ...
              {promos.map((p) => {
                return (
                  ...
                  >
                    ...
                    <CardFooter>
                      <VStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          Purchase price {p.xp?.PurchasePrice}
                        </HStack>
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          <img src={`${publicUrl}/Swipe.svg`} alt="" />
                          {formatPoints(p.xp?.MealsPerSemester)} Meals per semester
                        </HStack>
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          <img src={`${publicUrl}/Price.svg`} alt="" />$
                          <Text>{p.xp?.DinningDollars}</Text>
                          Dining dollars
                        </HStack>
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          <img src={`${publicUrl}/Guest.svg`} alt="" />
                          Guest meals : {p.xp?.GuestMeals}
                        </HStack>
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          <img src={`${publicUrl}/Swipe.svg`} alt="" />
                          Cash Equivalent : {p.xp?.CashEquivalency}
                        </HStack>
                      </VStack>
                    </CardFooter>
                  </Card>
            ...
            <Heading fontSize="lg">Choose your Meal Plan:</Heading>
            <SimpleGrid columns={3} spacing="40px" width="full" mb={8}>
              {packages.map((p) => {
                return (
                  <Card
                    variant="elevated"
                  ...
                  >
                    ...
                    <CardFooter>
                      ...
                      >
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          <img src={`${publicUrl}/Swipe.svg`} alt="" />
                          <Text>{p.xp?.MealsPerSemester} Meals per semester</Text>
                        </HStack>
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          <img src={`${publicUrl}/Price.svg`} alt="" />
                          <Text>{formatPrice(p.xp?.DinningDollars)} Dining dollars</Text>
                        </HStack>
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          <img src={`${publicUrl}/Calendar.svg`} alt="" />
                          <Text>{p.xp?.PerSemester}</Text>
                        </HStack>
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          <img src={`${publicUrl}/Guest.svg`} alt="" />
                          <Text>Guest meals : {p.xp?.GuestMeals}</Text>
                        </HStack>
                        <HStack w="full" width="100%" alignSelf="stretch" justifyContent="stretch">
                          <img src={`${publicUrl}/Swipe.svg`} alt="" />
                          <Text>Cash Equivalent : {p.xp?.CashEquivalency}</Text>
                        </HStack>
                        <HStack
                          w="full"
                          width="100%"
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        <ModalContent>
          ...
          <ModalBody p="50">
            <Text>
              You have successfuly subscribed to a package and now can dining at one of our campus
              locations.
            </Text>
            <HStack>
