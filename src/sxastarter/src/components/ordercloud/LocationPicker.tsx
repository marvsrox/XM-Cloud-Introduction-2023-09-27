...
export const Default = (): JSX.Element => {
  ...
  return (
    <VStack w="100%" width="full" textAlign="center" alignItems="center" p={4}>
      <HStack w="100%" width="full" textAlign="left" alignItems="center" maxW="1500px">
        <svg
          stroke="currentColor"
          fill="currentColor"
          stroke-width="0"
      ...
      <Modal isOpen={isAddressModalOpen} onClose={() => setIsAddressModalOpen(false)}>
        <ModalOverlay />
        <ModalContent w="100%" width="full" maxWidth="700px">
          <ModalHeader>Search for location</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <VStack>
              <HStack justifyContent="space-between" w="100%" width="full">
                <Formik
                ...
                <HStack width="50px" textAlign="center" pr="30px" pl="30px">
                  <Text>Or</Text>
                </HStack>
                <HStack width="150px" textAlign="center" justifyContent="space-between">
                  <a href="#">
                    <HStack w="100%" width="150px" pr="30px" pl="30px">
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
              ...
              <HStack mt={30} justifyContent="space-between" w="100%" width="full">
                <Text>
                  Lakeville <br />
                  17189 Kenyon Ave., <br />
                  Lakeville, MN <br />- 13.87 mi{' '}
                  <a href="#" onClick={() => setIsAddressModalOpen(false)}>
                    (Confirm)
                  </a>
                </Text>
                <Text>
