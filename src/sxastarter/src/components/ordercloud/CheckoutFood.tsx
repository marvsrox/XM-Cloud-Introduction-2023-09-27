    ...
    <>
      ...
      >
        ...
        >
          <HStack w="100%" width="full">
            <VStack w="100%" width="full" textAlign="left" alignItems="flex-start">
              <VStack w="100%" width="full" textAlign="left" alignItems="flex-start">
                {menuItems && menuItems.length ? (
                  <VStack w="100%" width="full" textAlign="left" alignItems="flex-start">
                    <Heading fontSize="x-large">MENU ITEMS FOR CURBSIDE PICKUP</Heading>
                    <HStack w="100%" width="full" textAlign="left" bgColor="#efeeee" p={4}>
                      <VStack w="100%" width="full" textAlign="left" alignItems="flex-start">
                        <Heading fontSize="lg" mb="0">
                          Ordering from: Lakeville
                        </Heading>
                        <Text>17189 Kenyon Ave., Lakeville, MN</Text>
                        <NextLink href="tel:952-898-5151" passHref>
                      ...
                      <HStack w="100%" width="full">
                        <Box
                          ...
                          borderRadius={2}
                        >
                          <Text onClick={() => setIsVehicleModalOpen(true)} cursor="pointer">
                            Change Vehicle
                          </Text>
                        </Box>
                      </HStack>
              ...
              <HStack w="100%" width="full" justifyContent="space-between">
                ...
                <HStack w="100%" width="full" alignItems="flex-end" justifyContent="flex-end">
          ...
          <HStack w="100%" width="full" textAlign="left" maxWidth="330px" ml={30}>
            <Card variant="">
              ...
              >
                <SliderMark value={25} mt="1" ml="-2.5" fontSize="12px">
                  25% <br />({formatPoints(availablePoints * 0.25)} pts)
                </SliderMark>
                <SliderMark value={50} mt="1" ml="-2.5" fontSize="12px">
                  50% <br />({formatPoints(availablePoints * 0.5)} pts)
                </SliderMark>
                <SliderMark value={75} mt="1" ml="-2.5" fontSize="12px">
              ...
              <HStack w="100%" width="full" justifyContent="space-between" mt={10}>
                <HStack>
              ...
              <HStack w="100%" width="full" justifyContent="space-between" mt={5}>
                <HStack>
                  <Text>Subtotal</Text>
                </HStack>
                <HStack>
              ...
              <HStack w="100%" width="full" justifyContent="space-between" mt={5} mb={10}>
                <HStack>
              ...
              <Divider mt={10} mb={10}></Divider>
              <Heading fontSize="xl" w="100%" width="full" textAlign="center">
                Make sure to double-
                <br />
                check your order <br />
                details!
              </Heading>
              <Text w="100%" width="full" fontSize="16" mb={15} textAlign="center">
      ...
      <Modal isOpen={isVehicleModalOpen} onClose={() => setIsVehicleModalOpen(false)}>
        ...
        <ModalContent width="full" w="100%" maxWidth="800px">
          ...
          <ModalBody>
            ...
            <Input placeholder="Vehicle make" height="45px" mt={2} mb={10} />
            <Heading fontSize="lg">Select your vehicle type</Heading>
            <HStack width="full" w="100%" mt={4} mb={10}>
              <HiChevronLeft fontSize="40px" color="brand.500" />
              <VStack>
                <Avatar
              ...
              <HiChevronRight fontSize="40px" color="brand.500" />
            </HStack>
      ...
      >
        ...
        <ModalContent width="full" w="100%" maxWidth="800px">
          ...
          <ModalCloseButton />
          <ModalBody>
            <Textarea placeholder="Preperation instructions" height="175px" />
            <VStack>
              <HStack
                w="100%"
                width="full"
